...
n_rooms_simulate = 1e4

n_mics = 50
reflection_coeff_min = 0.05
reflection_coeff_max = 0.7
scatter_coeff = 0.15
room_max_size = 10
room_min_size = 1
...
sound_source_max_speed = 1 # m/s
sound_source_locations_per_recording = 20 # number of locations to simulate the sound source at (instead of moving the source) Note: this is inculding the extra_samples_start_for_echo
