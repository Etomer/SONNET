...
class ResNet(nn.Module):
    ...
    def __init__(self, input_size, block_width, n_blocks, output_size, dropout = 0.1, scale_cnn = 1):
        ...
        self.cnn = nn.Sequential(
            nn.Conv1d(2,10*scale_cnn,100,20),
            nn.GELU(),
            nn.Conv1d(10*scale_cnn,30*scale_cnn,50,10),
            nn.GELU(),
            nn.Conv1d(30*scale_cnn,50*scale_cnn,25,5),
            nn.GELU(),
            nn.Flatten(),
        )
        
        self.proj = nn.Linear(250*scale_cnn,block_width)
